...
%% @doc Represents a single reduce worker node. See the documentation for protocol
%%     definition.
...
%% @doc Receives and collects map results from mappers until receives 
%%     start_reducing message from master. Function returns master PID and collected data.
